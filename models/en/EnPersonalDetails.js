...
const EnpersonalDetailsSchema = new mongoose.Schema(
  {
    userId: {
      type: mongoose.Schema.Types.ObjectId,
      ref: "EnUser", // References your User model
...
export default mongoose.model("EnPersonalDetails", EnpersonalDetailsSchema);
